...
public class MailSendSerlvet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String[] conAry = content.split("");		//엔터키 들어가는 부분
		...
		Authenticator auth = new MyAuthentication("gwgtis135", "Ekftoxodn12!!");			//인증 하는 부분 
		...
		try {
			...
			from = new InternetAddress("gwgtis135@naver.com");	//발신자
			msg.setFrom(from);									//발신자 정보 

			InternetAddress to = new InternetAddress("gwgtis135@gmail.com");	//수신자
